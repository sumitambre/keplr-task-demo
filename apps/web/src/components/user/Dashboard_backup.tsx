      ...
      <div className="border-b bg-gradient-to-b from-muted/40 to-background">
        <div className="mx-auto max-w-4xl px-6 py-8">
          <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            {/* Date Selection bar (mirrors admin) */}
          ...
          <CardContent>
            ...
            return (
              <Card className="mt-4 rounded-xl shadow-sm border border-gray-100" style={{ backgroundColor: '#FDE7E7' }}>
                <div className="flex items-center gap-2 p-4 text-[#B42318]">
            ...
            {(() => {
              ...
              return (
                <div className="mt-4 grid grid-cols-2 gap-4 md:grid-cols-4">
                  <Card className={`${baseCard} bg-card text-card-foreground`}>
                    <div className={baseInner}>
                      <div className={`${titleCls} text-foreground`}>
                        <ListTodo className="h-4 w-4 text-muted-foreground" />
                        Total Tasks
                      </div>
                      <div className={`${valueCls} text-foreground`}>{total}</div>
                    </div>
                  </Card>
                  <Card className={`${baseCard} bg-card text-card-foreground`} >
                    <div className={baseInner}>
                      <div className={`${titleCls} text-[#1B5E20}`}>
                        <CheckCircle2 className="h-4 w-4" />
                        Completed
                      </div>
                      <div className={${valueCls} text-foreground`}>{completed}</div>
                    </div>
                  </Card>
                  <Card className={`${baseCard}`} >
                    <div className={baseInner}>
                      ...
                      <div className={${valueCls} text-foreground`}>{inProgress}</div>
                    </div>
                  </Card>
                  <Card className={`${baseCard}`} >
                    <div className={baseInner}>
                      ...
                      <div className={${valueCls} text-foreground`}>{pending}</div>
                    </div>
                  </Card>
                </div>
              );
